const styles = {
  ...
  heading:
    "text-[20px] sm:text-[27px] md:text-start font-[600] font-Roboto pb-[20px]",
  section: "w-11/12 mx-auto",
  productTitle: "text-[18px] sm:text-[25px] font-[600] font-Roboto text-[#333]",
  productDiscountPrice: "font-bold text-[18px] text-[#333] font-Roboto",
  price: "font-[500] text-[14px] text-[#d55b45] pl-1 mt-[-4px] line-through",
  shop_name: "pt-8 text-[15px] inline-flex text-blue-400 pb-3",
  active_indicator: "absolute bottom-[-27%] left-0 h-[3px] w-full bg-[crimson]",
  button:
    "w-[140px] bg-black h-[35px] my-3 flex items-center justify-center rounded-xl cursor-pointer hover:bg-slate-700",
  cart_button:
